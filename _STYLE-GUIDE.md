...
Please use this style guide a reference to write consistent code. When in doubt, refer to the excellent [Airbnb JavaScript Style Guide](https://github.com/airbnb/javascript) and for React, the [Airbnb React/JSX Style Guide](https://github.com/airbnb/javascript/tree/master/react) for additional guidance.
